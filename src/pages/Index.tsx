...
const Index = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-black">
          ...
          <div className="mt-6">
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <Input 
                ...
                required 
                className="flex-1 bg-white/10 text-white placeholder:text-gray-400 border-0 rounded-sm focus-visible:ring-1 focus-visible:ring-white/30" 
              />
              <Button 
                type="submit" 
                disabled={isLoading} 
      ...
      {/* Beta Notice - Above Footer */}
      <div className="absolute bottom-32 left-0 right-0 z-20 text-center">
